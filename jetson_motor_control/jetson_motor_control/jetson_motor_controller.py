#!/usr/bin/env python3
"""
Jetson Motor Control Node
ROS2 node for differential drive robot control with GPIO interface
"""
...
class JetsonMotorController(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("Jetson Motor Controller initialized")
    ...
    def _handle_joystick_control(self, x_axis, y_axis):
        ...
        left_speed = forward + turn * 0.45
        right_speed = forward - turn * 0.45
    ...
    def _publish_status(self):
        ...
        status = f"{mode} | Motors: {enabled} | {estop} | Speed: {self.current_speed_scale:.1f}{analog}{brake}"
